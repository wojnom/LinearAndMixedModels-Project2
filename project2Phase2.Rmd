...
As we have stated in the beginning, we are interested in a influence of mouse genotype on the length of dendritic spines. Thus, we add `mouse` to our model as a fixed effect. 

###Treatment

`log(length)` differs among treatment types (boxplot below). 
